...
DAMAGE_CLOSE = 30       # damage when NPC is within close range
DAMAGE_FAR = 10         # damage when NPC is farther away
CLOSE_ATTACK_DIST = TILE * 2   # distance threshold (in px) for close vs far damage

# barrel explosion settings
BARREL_EXPLOSION_DAMAGE = 40
BARREL_EXPLOSION_RADIUS = TILE * 2   # 200px — anything inside gets hit
